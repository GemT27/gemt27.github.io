...
(function webpackUniversalModuleDefinition(root, factory) {
	if (typeof exports === 'object' && typeof module === 'object')
		...
		exports["vlLayer"] = factory();
	else
		root["vlLayer"] = factory();
	...
	({
		...
		"3a3b":
			...
			(function(module, __webpack_exports__, __webpack_require__) {
				...
				/* harmony import */
				var
					_node_modules_mini_css_extract_plugin_dist_loader_js_ref_10_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_prompt_vue_vue_type_style_index_0_id_6c69dd9a_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__("c1cd");
				/* harmony import */
				var
					_node_modules_mini_css_extract_plugin_dist_loader_js_ref_10_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_prompt_vue_vue_type_style_index_0_id_6c69dd9a_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/
		...
		"3a87":
			...
			(function(module, __webpack_exports__, __webpack_require__) {
				...
				/* harmony import */
				var
					_node_modules_mini_css_extract_plugin_dist_loader_js_ref_10_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_layer_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__("9790");
				/* harmony import */
				var
					_node_modules_mini_css_extract_plugin_dist_loader_js_ref_10_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_layer_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/
					__webpack_require__.n(
						_node_modules_mini_css_extract_plugin_dist_loader_js_ref_10_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_layer_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__
					);
				/* unused harmony reexport * */
		...
		"72af":
			...
			(function(module, __webpack_exports__, __webpack_require__) {
				...
				/* harmony import */
				var
					_node_modules_mini_css_extract_plugin_dist_loader_js_ref_10_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_button_vue_vue_type_style_index_0_id_56ca3248_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__("af37");
				/* harmony import */
				var
					_node_modules_mini_css_extract_plugin_dist_loader_js_ref_10_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_button_vue_vue_type_style_index_0_id_56ca3248_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/
					__webpack_require__.n(
						_node_modules_mini_css_extract_plugin_dist_loader_js_ref_10_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_button_vue_vue_type_style_index_0_id_56ca3248_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__
					);
				/* unused harmony reexport * */
		...
		"8418":
			...
			(function(module, exports, __webpack_require__) {
				...
				module.exports = function(object, key, value) {
					...
					if (propertyKey in object) definePropertyModule.f(object, propertyKey, createPropertyDescriptor(0,
						value));
		...
		"a0bb":
			...
			(function(module, __webpack_exports__, __webpack_require__) {
				...
				/* harmony import */
				var
					_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_mask_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__("cc28");
				/* harmony import */
				var
					_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_mask_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/
					__webpack_require__.n(
						_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_mask_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__
					);
				/* unused harmony reexport * */
		...
		"fb15":
			...
			(function(module, __webpack_exports__, __webpack_require__) {
				...
				if (typeof window !== 'undefined') {
					...
					var setPublicPath_i
					if ((setPublicPath_i = window.document.currentScript) && (setPublicPath_i = setPublicPath_i.src.match(
							/(.+\/)[^/]+\.js(\?.*)?$/))) {
				...
				var alertvue_type_template_id_62c416f8_render = function() {
					var _vm = this;
					var _h = _vm.$createElement;
					var _c = _vm._self._c || _h;
					return _c('base-drag', {
					...
					}, [(this.options.icon == 0) ? _c('i', {
						staticClass: "vlayer vlicon-warning",
						staticStyle: {
							"color": "#f4ea2a",
							"font-size": "32px"
						}
					}) : _vm._e(), (this.options.icon == 1) ? _c('i', {
						staticClass: "vlayer vlicon-error",
						staticStyle: {
							"color": "#f4ea2a",
							"font-size": "32px"
						}
					}) : _vm._e(), (this.options.icon == 2) ? _c('i', {
						staticClass: "vlayer vlicon-success",
						staticStyle: {
							"color": "#00ba9b",
							"font-size": "32px"
						}
					}) : _vm._e(), (this.options.icon == 3) ? _c('i', {
						...
						domProps: {
							"innerHTML": _vm._s(_vm.options.content)
						}
					})]), _c('div', {
					...
					}, [_vm._v(_vm._s(_vm.btns[0]))]), (typeof(_vm.options.cancel) == 'function' || _vm.options
						.cancel == 'cancel') ? _c('pzbutton', {
						staticStyle: {
							"margin-left": "10px"
						},
						attrs: {
					...
					}, [_vm._v(_vm._s(_vm.btns[1]))]) : _vm._e()], 1)])
				}
				...
				var buttonvue_type_template_id_56ca3248_scoped_true_render = function() {
					var _vm = this;
					var _h = _vm.$createElement;
					var _c = _vm._self._c || _h;
					return _c('button', {
				...
				/* harmony default export */
				var button_buttonvue_type_script_lang_js_ = (buttonvue_type_script_lang_js_);
				...
				/* harmony default export */
				var button_button = (component.exports);
				...
				var helper_helper = /*#__PURE__*/ function() {
					...
					_createClass(helper, null, [{
						...
						key: "btncancel",
						value: function() {
							var _btncancel = _asyncToGenerator( /*#__PURE__*/ regeneratorRuntime.mark(function _callee(
								event, options) {
				...
				var dragvue_type_template_id_053989da_render = function() {
					var _vm = this;
					var _h = _vm.$createElement;
					var _c = _vm._self._c || _h;
					return _c('div', {
						...
						domProps: {
							"innerHTML": _vm._s(_vm.options.title)
						}
					}), (_vm.options.maxmin == true) ? [_c('span', {
						staticClass: "lv-icon-maxmini"
					}, [(_vm.maxMiniState === 0) ? [_c('i', {
					...
					})] : (_vm.maxMiniState === 1) ? [_c('i', {
						staticClass: "vlayer vlicon-huanyuan lv-icon-max",
						on: {
							"click": _vm.maxmini
						}
					})] : (_vm.maxMiniState === 2) ? [_c('i', {
						staticClass: "vlayer vlicon-huanyuan lv-icon-max",
						on: {
							"click": _vm.maxmini
						}
					})] : _vm._e()], 2)] : _vm._e(), _c('i', {
						staticClass: "icon-remove",
						on: {
							"click": _vm.close
						}
					})], 2), _vm._t("default"), (_vm.options.resize) ? _c('span', {
						staticClass: "vl-drag-resize",
						on: {
							"mousedown": _vm.resizeHand,
							"mouseup": _vm.resizeHandMoveEnd
						}
					}) : _vm._e()], 2)
				}
				// resizeOptions
				...
				/* harmony default export */
				var dragvue_type_script_lang_js_ = ({
					data: function data() {
						return {
							moveLeft: 0,
							//左移的距离
					...
					mounted: function mounted() {
						...
						if (o) {
							document.removeEventListener("mouseup", this.resizeHandMoveEnd)
						}
							...
							return regeneratorRuntime.wrap(function _callee$(_context) {
								while (1) {
									switch (_context.prev = _context.next) {
										...
										case 3:
											//是否显示遮罩
											document.getElementsByClassName("vl-notify-mask")[0].addEventListener(
												"mousemove",
												function(event) {
													_this.move(event);
												});
					...
					methods: {
								...
								return regeneratorRuntime.wrap(function _callee2$(_context2) {
									while (1) {
										switch (_context2.prev = _context2.next) {
											...
											case 2:
												helper_helper.clickMaskCloseAll(event, _this2.options.layer, _this2.options
													.id);
						...
						mini: function mini() {
							...
							if (doms && doms.length) {
								for (var i = 0; i < doms.length; i++) {
									if (doms[i] && doms[i]._maxMiniState === 1) {
										count++
									}
								}
								count = count ? count : 0;
							...
							this.options.stateCallback && this.options.stateCallback(this.options.id)
						...
						moveEnd: function moveEnd() {
							...
							var o = document.getElementById(this.options.id + "");
							if (o) {
								var dom = o.getElementsByClassName("vl-notice-mask")[0];
								if (dom) {
									dom.removeEventListener("mousemove", this.move)
									dom.removeEventListener("mouseup", this.moveEnd)
								}
							}
						},
						resizeHand: function resizeHand(event) {
							...
							document.addEventListener("mousemove", this.resizeHandMove);
							document.addEventListener("mouseup", this.resizeHandMoveEnd);
						},
						...
						resizeHandMoveEnd: function resizeHandMoveEnd() {
							...
							var o = document.getElementById(this.options.id + "");
							if (o) {
								document.removeEventListener("mousemove", this.resizeHandMove)
								document.removeEventListener("mouseup", this.resizeHandMoveEnd)
							}
						}
					}
				...
				/* harmony default export */
				var drag_dragvue_type_script_lang_js_ = (dragvue_type_script_lang_js_);
				...
				/* harmony default export */
				var drag = (drag_component.exports);
				...
				/* harmony default export */
				var src_alertvue_type_script_lang_js_ = (alertvue_type_script_lang_js_);
				...
				/* harmony default export */
				var src_alert = (alert_component.exports);
				...
				var loadingvue_type_template_id_42af42a2_render = function() {
					var _vm = this;
					var _h = _vm.$createElement;
					var _c = _vm._self._c || _h;
					return _c('label', {
					...
					}, [_c('span'), (_vm.options.content != '') ? _c('i', {
						domProps: {
							"innerHTML": _vm._s(_vm.options.content)
						}
					}) : _vm._e()])
				...
				var msgvue_type_template_id_4b1a7fb4_render = function() {
					var _vm = this;
					var _h = _vm.$createElement;
					var _c = _vm._self._c || _h;
					return _c('label', {
				...
				/* harmony default export */
				var msgvue_type_script_lang_js_ = ({
					data: function data() {
						return {
							timeout: ''
						};
				...
				/* harmony default export */
				var src_msgvue_type_script_lang_js_ = (msgvue_type_script_lang_js_);
				...
				//
				/* harmony default export */
				var tipsvue_type_script_lang_js_ = ({
					data: function data() {
						return {
							timeout: ''
						};
									...
									while (1) {
										switch (_context2.prev = _context2.next) {
											...
											case 2:
												...
												_context2.next = _context2.t0 === 0 ? 15 : _context2.t0 === 1 ? 17 :
													_context2.t0 === 2 ? 19 : _context2.t0 === 3 ? 21 : 23;
												break;
				...
				/* harmony default export */
				var src_tipsvue_type_script_lang_js_ = (tipsvue_type_script_lang_js_);
				...
				/* harmony default export */
				var tips = (tips_component.exports);
				...
				var pagevue_type_template_id_c733a1fa_lang_html_render = function() {
					var _vm = this;
					var _h = _vm.$createElement;
					var _c = _vm._self._c || _h;
					return _c('div', {
					...
					}, [_vm._v(_vm._s(_vm.options.title))]), _c('div', {
				...
				//
				/* harmony default export */
				var pagevue_type_script_lang_js_ = ({
					data: function data() {
						return {
							moveLeft: 0,
							//左移的距离
				...
				/* harmony default export */
				var src_pagevue_type_script_lang_js_ = (pagevue_type_script_lang_js_);
				...
				/* harmony default export */
				var page = (page_component.exports);
				...
				var iframevue_type_template_id_a46319fa_render = function() {
					var _vm = this;
					var _h = _vm.$createElement;
					var _c = _vm._self._c || _h;
					return _c('base-drag', {
				...
				/* harmony default export */
				var iframevue_type_script_lang_js_ = ({
					data: function data() {
						return {
							cls: {
									...
									while (1) {
										switch (_context2.prev = _context2.next) {
											...
											case 2:
												...
												propsData["lyId"] = _this2.options.id;
												propsData["lyData"] = _this2.options.content.data;
												propsData["lyState"] = _this2.options.content.state;
				...
				/* harmony default export */
				var src_iframevue_type_script_lang_js_ = (iframevue_type_script_lang_js_);
				...
				/* harmony default export */
				var iframe = (iframe_component.exports);
				...
				var promptvue_type_template_id_6c69dd9a_scoped_true_render = function() {
					var _vm = this;
					var _h = _vm.$createElement;
					var _c = _vm._self._c || _h;
					...
					return _c('base-drag', {
					...
					}, [((_vm.inputType) === 'checkbox' && (_vm.options.formType != 3)) ? _c('input', {
						directives: [{
							name: "model",
							rawName: "v-model",
						...
						staticClass: "vl-input",
						attrs: {
							"type": "checkbox"
						},
						domProps: {
							"checked": Array.isArray(_vm.form.value) ? _vm._i(_vm.form.value, null) > -1 : (
								_vm.form.value)
						},
						on: {
							"change": function($event) {
								...
								if (Array.isArray($$a)) {
									var $$v = null,
										$$i = _vm._i($$a, $$v);
									if ($$el.checked) {
										$$i < 0 && (_vm.$set(_vm.form, "value", $$a.concat([$$v])))
									} else {
										$$i > -1 && (_vm.$set(_vm.form, "value", $$a.slice(0, $$i).concat($$a.slice(
											$$i + 1))))
									}
								} else {
					...
					}) : ((_vm.inputType) === 'radio' && (_vm.options.formType != 3)) ? _c('input', {
						directives: [{
							name: "model",
							rawName: "v-model",
							value: (_vm.form.value),
					...
					}) : (_vm.options.formType != 3) ? _c('input', {
						directives: [{
							name: "model",
							rawName: "v-model",
							value: (_vm.form.value),
				...
				/* harmony default export */
				var promptvue_type_script_lang_js_ = ({
					data: function data() {
						return {
							cls: {
								"vl-notify-iframe": true
				...
				/* harmony default export */
				var src_promptvue_type_script_lang_js_ = (promptvue_type_script_lang_js_);
				...
				/* harmony default export */
				var src_prompt = (prompt_component.exports);
				...
				/* harmony default export */
				var layervue_type_script_lang_js_ = ({
					data: function data() {
						return {
							id: "",
							type: 0,
				...
				/* harmony default export */
				var src_layervue_type_script_lang_js_ = (layervue_type_script_lang_js_);
				...
				/* harmony default export */
				var maskvue_type_script_lang_js_ = ({
					data: function data() {
						return {
							id: "",
							type: 0,
				...
				/* harmony default export */
				var src_maskvue_type_script_lang_js_ = (maskvue_type_script_lang_js_);
				...
				/* harmony default export */
				var mask = (mask_component.exports);
				...
				var layer_Notification = function Notification(Vue) {
					...
					self.open = function(options) {
                        ...
                        if(options.parentDom){
                            ...
                            // 不传parentDom 默认添加到 screen-wrapper 内
                            document.body.appendChild(instance.vm.$el);
                            // document.querySelector('.screen-wrapper').appendChild(instance.vm.$el);
                        }
					...
					self.canmove = function(id, bool) {
						if (!self.instancesVue[id]) {
							return
						}
						self.instancesVue[id].main.canmove = bool;
					...
					self.close = function(id) {
						...
						var time2 = self.instancesVue[id]._time;
						if (time2 && time - time2 < 100) {
							return
						}
						self.instancesVue[id]._time = time;
						var fn = self.instancesVue[id].main.beforeClose;
						if (typeof fn === 'function' && !fn.call(self, id, self._close)) {
							return
						}
						self._close(id)
					}

					self._close = function(id) {
						if (!self.instancesVue[id]) {
							return
						}
						var fn2 = self.instancesVue[id].main.end;
						fn2 && fn2()
						var oElm = document.getElementById(id);

						if (oElm) {
							document.body.removeChild(oElm);
							// document.querySelector('.screen-wrapper').removeChild(oElm);
				...
				/* harmony default export */
				var layer_src_layer = (layer_Notification);
				...
				/* harmony default export */
				var packages_layer = (layer_src_layer);
				// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


				/* harmony default export */
				var entry_lib = __webpack_exports__["default"] = (packages_layer);
